...
Reduces all crafting and processing times to zero (instant) of their original duration (Instant). Includes complete compatibility with all AgentKush mod recipes.

## Features

### Speed Modification
- **Processing Time:** Reduced to zero (instant) (Instant)
