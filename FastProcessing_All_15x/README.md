...
Reduces all crafting and processing times to ~6.7% of their original duration (15x speed increase). Includes complete compatibility with all AgentKush mod recipes.
...
| FastProcessing 15x | 15x faster | 3,677 |
